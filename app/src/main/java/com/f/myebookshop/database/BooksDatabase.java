...
public abstract class BooksDatabase extends RoomDatabase {
    ...
    private static class InitialDataAsyncTask extends AsyncTask<Void, Void, Void>{
        ...
        protected Void doInBackground(Void... voids) {
            ...
            booksDAO.insert(book7);
            booksDAO.insert(book8);
            booksDAO.insert(book9);
            booksDAO.insert(book10);
            booksDAO.insert(book11);
            booksDAO.insert(book12);
            booksDAO.insert(book13);
            booksDAO.insert(book14);
            booksDAO.insert(book15);
            booksDAO.insert(book16);
